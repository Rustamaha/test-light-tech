	...
	return (
		<div className='footer'>
			<div className='footer__row footer__row_contacts'>
				<div className='footer__cell'><a className='footer__link footer__link_home' href='#home'><span className='footer__logo'></span></a></div>
       	<div className='footer__cell'><a className='footer__link' href='#phone'><i className='fas fa-phone footer__phone'></i> 8-800-900-500-5</a></div>
       	...
       	<div className='footer__cell'><span>&copy;2019 Ресторан японской кухни Japanito</span></div>
      </div>
      <div className='footer__row footer__row_menu-left'>
        ...
        <div className='footer__cell'><a className='footer__link' href='#delivery'>Доставка</a></div>
     	...
     	<div className='footer__row footer__row_menu-right'>
      ...
      <div className='footer__row footer__row_buttons'>
      	<div className='footer__cell footer__cell_input'>
       	...
       	<div className='footer__cell'><button className='footer__review-button'>Отправить отзыв</button></div>
      </div>
		</div>
	);
}
